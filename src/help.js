...
◪ *INFO*
  ❏ Prefixo: 「  ${prefix}  」
  │
  ├─ ❏ ${prefix}server no discord: https://discord.gg/cZSuAMKZqV

  ├─ ❏ ${prefix}instagram : https://www.instagram.com/shitpost.do.refrizin
  ├─ ❏ ${prefix}grupo whatsapp :https://chat.whatsapp.com/EGNP28tffxmHRyvu2pwCxu
  ├─ ❏ ${prefix} contato do dono wa.me/553184903469
  └─ ❏ ${prefix}telegram: t.me/shitpost_do_refrizin

◪ *CRIADOR* 
  │
  ├─ ❏ ${prefix}sticker      ☆  converter imagem em stickers
...
◪ *SONS*
  │
  ├─ ❏ ${prefix}play  comando para baixar músicas
  └─ ❏ ${prefix}tts
◪ *MUSICA*
  │
  ├─ ❏ ${prefix}lirik
...
◪ *SOMENTE DONO DO BOT*
  ...
  ├─ ❏ ${prefix}clone    ☆ usar a foto de um ctt 
...
◪ *OUTROS*
  ...
  ├─ ❏ ${prefix}virtex     ☆ comando pra enviar trava
  ├─ ❏ ${prefix}exe
